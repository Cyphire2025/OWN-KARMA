...
if __name__ == "__main__":
    base_dir = os.getcwd()
    video_path = os.path.join(base_dir, 'public', 'video', 'car1.mp4')
    output_path = os.path.join(base_dir, 'public', 'images', 'car1')
    
    count = extract_frames(video_path, output_path)
    
    # Append to manifest if possible, or just print
    print(f"\nDONE! Extracted {count} frames for Car1.")
    # We will manually note this count for the code
